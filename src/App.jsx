...
const App = () => {
  // step 1 move the posts to a new folder -data/db.json
  ...
  // step 2- structure the useEffect
  useEffect(() => {
  ...
  // step 3 - make the fn async, then manipulate the code
